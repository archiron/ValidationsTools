...
'''
    for i in range(0, N_histos): # 1 histo for debug
        ...
        KSname1 = dfo.folder + "histo_" + br[i] + "_KScurve1.txt"
        KSname2 = dfo.folder + "histo_" + br[i] + "_KScurve2.txt"
        KSname3 = dfo.folder + "histo_" + br[i] + "_KScurve3.txt"
       ...
       # get nb of columns & rows for histos
        ...
        for k in range(0,Nrows):
            ...
            plt.plot(curves)
        fig.savefig(dfo.folder + '/cumulative_curve_' + br[i] + '.png')
        fig.clf()
