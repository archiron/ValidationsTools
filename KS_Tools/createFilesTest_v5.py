...
fileName1 = pathKS + '/KS-ttlDiff_1_' + branche + '_v9a.png'
title = 'stats. ' + branche
...
print('time for branche : {:.4f} seconds'.format(tec-tuc))
print('time for histos array : {:.4f} seconds'.format(t2-t1))
print('time for complete loop for 1 histo : {:.4f} seconds'.format(toc-t1))
for elem in t_time:
